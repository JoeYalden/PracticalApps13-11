            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<int>("EmployeeId").HasColumnName("EmployeeID").IsFixedLength();

                        j.IndexerProperty<string>("TerritoryId").HasMaxLength(20).HasColumnName("TerritoryID").IsFixedLength();
                    });
            });
